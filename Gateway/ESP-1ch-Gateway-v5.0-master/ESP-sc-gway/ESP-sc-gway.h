...
#define _DESCRIPTION "Little gateway for our home"			// Name of the gateway
#define _EMAIL "s181927@student.dtu.dk"		// Owner
#define _PLATFORM "ESP8266"
#define _LAT 55.70792839
#define _LON 12.51131565
#define _ALT 1								// Altitude

// ntp
// Please add daylight saving time to NTP_TIMEZONES when desired
#define NTP_TIMESERVER "dk.pool.ntp.org"	// Country and region specific
...
#define TRUSTED_NODES 0
#define TRUSTED_DECODE 0
...
wpas wpa[] = {
	...
	{ "HomeBox-E388", "2d1ea376a" },
	{ "Hotspot Draths", "353378733" }
};
